...
class UPSTest < Minitest::Test
  ...
  def test_get_delivery_dates_can_parse_delivery_estimates
    ...
    response = @carrier.get_delivery_dates(
    ...
    assert response.is_a?(ActiveShipping::DeliveryDatesResponse)
  ...
  def test_get_delivery_dates_can_translate_service_codes
